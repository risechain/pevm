                        ...
                        for (tx_idx, memory_entry) in write_history.iter() {
                            match memory_entry {
                                ...
                                MemoryEntry::Data(
                                    ...
                                    let new_storage_value = storage_value + amount;
                                    if storage_value.is_zero() != *zeroness_before
                                        || new_storage_value.is_zero() != *zeroness_after
                                    {
                                    ...
                                    storage_value = new_storage_value;
                                }
                                MemoryEntry::Data(
                                    _,
